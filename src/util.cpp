...
#else
    const char* pszModule = "supermoon";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\supermoon
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\supermoon
    // Mac: ~/Library/Application Support/supermoon
    // Unix: ~/.supermoon
#ifdef WIN32
    // Windows
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "supermoon.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "supermoond.pid"));
