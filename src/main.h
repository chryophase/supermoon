...
// Copyright (c) 2018-2019 The Supermoon Developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
// Supermoon version v1.22  PRODUCTION RELEASE  1.2.0.2 	(Mar 24- 2019) - POS 3.5
...
/** Fees smaller than this (in SUPM calculated to factors equivelent satoshi s) are considered zero fee (for transaction creation) */
static const int64_t MIN_TX_FEE = 10000;
/** Fees smaller than this (in SUPM calculated to factors equivelent satoshi s) are considered zero fee (for relaying) */
...
static const int64_t COIN_YEAR_REWARD = 100 * CENT; // Base 100% APR
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees, int64_t SupermoonCoinStake );  //POS 3.5
